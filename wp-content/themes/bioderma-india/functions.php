...
function subscribe_user(){
	$str='';
    if(isset($_POST['email']) && wp_verify_nonce( $_POST['security'], 'bioderma-india' )==true) {
    if ( email_exists( $_POST['email'] ) ) {
    $str='EXISTS';
	}else{
	$website = "bioderma-india";
	$userdata = array(
...
function woo_variable_fields( $loop, $variation_data, $variation ) {
  ...
  echo '<div class="variation-custom-fields">';
      ...
      woocommerce_wp_text_input( 
        array( 
          'id'          => '_amazon_text_field['. $loop .']', 
          'label'       => __( 'Amazon_Url', 'woocommerce' ), 
          'placeholder' => 'http://',
          //'desc_tip'    => true,
          'wrapper_class' => 'form-row form-row-first',
          //'description' => __( 'Enter the custom value here.', 'woocommerce' ),
          'value'       => get_post_meta($variation->ID, '_amazon_text_field', true)
        )
      );
      // Text Field
      woocommerce_wp_text_input( 
        array( 
          'id'          => '_flipkart_text_field['. $loop .']', 
          'label'       => __( 'Flipkart_Url', 'woocommerce' ), 
          'placeholder' => 'http://',
          //'desc_tip'    => true,
          'wrapper_class' => 'form-row form-row-last',
          //'description' => __( 'Enter the custom value here.', 'woocommerce' ),
          'value'       => get_post_meta($variation->ID, '_flipkart_text_field', true)
        )
      );
      ...
      woocommerce_wp_text_input( 
        array( 
          'id'          => '_nykaa_text_field['. $loop .']', 
          'label'       => __( 'Nykaa_Url', 'woocommerce' ), 
          'placeholder' => 'http://',
          //'desc_tip'    => true,
          'wrapper_class' => 'form-row form-row-first',
          //'description' => __( 'Enter the custom value here.', 'woocommerce' ),
          'value'       => get_post_meta($variation->ID, '_nykaa_text_field', true)
        )
      );
      // Text Field
      woocommerce_wp_text_input( 
        array( 
          'id'          => '_snapdeal_text_field['. $loop .']', 
          'label'       => __( 'Snapdeal_Url', 'woocommerce' ), 
          'placeholder' => 'http://',
          //'desc_tip'    => true,
          'wrapper_class' => 'form-row form-row-last',
          //'description' => __( 'Enter the custom value here.', 'woocommerce' ),
          'value'       => get_post_meta($variation->ID, '_snapdeal_text_field', true)
        )
      );
      // Text Field
      woocommerce_wp_text_input( 
        array( 
          'id'          => '_netmeds_text_field['. $loop .']', 
          'label'       => __( 'Netmeds_Url', 'woocommerce' ), 
          'placeholder' => 'http://',
          //'desc_tip'    => true,
          'wrapper_class' => 'form-row form-row-first',
          //'description' => __( 'Enter the custom value here.', 'woocommerce' ),
          'value'       => get_post_meta($variation->ID, '_netmeds_text_field', true)
        )
      );
      // Text Field
      woocommerce_wp_text_input( 
        array( 
          'id'          => '_Care_to_beauty_text_field['. $loop .']', 
          'label'       => __( 'Care-to-beauty_Url', 'woocommerce' ), 
          'placeholder' => 'http://',
          //'desc_tip'    => true,
          'wrapper_class' => 'form-row form-row-last',
          //'description' => __( 'Enter the custom value here.', 'woocommerce' ),
          'value'       => get_post_meta($variation->ID, '_Care_to_beauty_text_field', true)
        )
      );
      // Text Field
      woocommerce_wp_text_input( 
        array( 
          'id'          => '_medlife_text_field['. $loop .']', 
          'label'       => __( 'Medlife_Url', 'woocommerce' ), 
          'placeholder' => 'http://',
          //'desc_tip'    => true,
          'wrapper_class' => 'form-row form-row-first',
          //'description' => __( 'Enter the custom value here.', 'woocommerce' ),
          'value'       => get_post_meta($variation->ID, '_medlife_text_field', true)
        )
      );
      // Text Field
      woocommerce_wp_text_input( 
        array( 
          'id'          => '_1mg_text_field['. $loop .']', 
          'label'       => __( '1mg_Url', 'woocommerce' ), 
          'placeholder' => 'http://',
          //'desc_tip'    => true,
          'wrapper_class' => 'form-row form-row-last',
          //'description' => __( 'Enter the custom value here.', 'woocommerce' ),
          'value'       => get_post_meta($variation->ID, '_1mg_text_field', true)
        )
      );
...
function save_variation_fields( $variation_id, $i) {
    ...
    $amazon_field = stripslashes( $_POST['_amazon_text_field'][$i] );
    $flipkart_field = stripslashes( $_POST['_flipkart_text_field'][$i] );
    $nykaa_field = stripslashes( $_POST['_nykaa_text_field'][$i] );
    $snapdeal_field = stripslashes( $_POST['_snapdeal_text_field'][$i] );
    $netmeds_field = stripslashes( $_POST['_netmeds_text_field'][$i] );
    $Care_to_beauty_field = stripslashes( $_POST['_Care_to_beauty_text_field'][$i] );
    $medlife_field = stripslashes( $_POST['_medlife_text_field'][$i] );
    $mg_field = stripslashes( $_POST['_1mg_text_field'][$i] );


     update_post_meta( $variation_id, '_amazon_text_field', esc_attr( $amazon_field ) );
     update_post_meta( $variation_id, '_flipkart_text_field', esc_attr( $flipkart_field ) );
     update_post_meta( $variation_id, '_nykaa_text_field', esc_attr( $nykaa_field ) );
     update_post_meta( $variation_id, '_snapdeal_text_field', esc_attr( $snapdeal_field ) );
     update_post_meta( $variation_id, '_netmeds_text_field', esc_attr( $netmeds_field ) );
     update_post_meta( $variation_id, '_Care_to_beauty_text_field', esc_attr( $Care_to_beauty_field ) );
     update_post_meta( $variation_id, '_medlife_text_field', esc_attr( $medlife_field ) );
     update_post_meta( $variation_id, '_1mg_text_field', esc_attr( 
     	$mg_field ) );
...
function custom_load_variation_settings_products_fields( $variations ) {
  $variations['flipkart_Url'] = get_post_meta( $variations[ 'variation_id' ], '_flipkart_text_field', true );  
  $variations['amazon_Url'] = get_post_meta( $variations[ 'variation_id' ], '_amazon_text_field', true ); 
  $variations['nykaa_Url'] = get_post_meta( $variations[ 'variation_id' ], '_nykaa_text_field', true );  
  $variations['snapdeal_Url'] = get_post_meta( $variations[ 'variation_id' ], '_snapdeal_text_field', true );  
  $variations['netmeds_Url'] = get_post_meta( $variations[ 'variation_id' ], '_netmeds_text_field', true );  
  $variations['care_to_beauty_Url'] = get_post_meta( $variations[ 'variation_id' ], '_Care_to_beauty_text_field', true );  
  $variations['medlife_Url'] = get_post_meta( $variations[ 'variation_id' ], '_medlife_text_field', true );  
  $variations['1mg_Url'] = get_post_meta( $variations[ 'variation_id' ], '_1mg_text_field', true );  
  return $variations;
}
...
//alt tag for Gravatar
function optimize_gravatar_alt($optimizeGravatar) {
	if (have_comments()) {
	...
	$optimizeGravatar = str_replace('alt=\'\'', 'alt=\'Avatar for ' . $alt . '\' title=\'Gravatar for ' . $alt . '\'', $optimizeGravatar);
	return $optimizeGravatar;
}
add_filter('get_avatar', 'optimize_gravatar_alt');