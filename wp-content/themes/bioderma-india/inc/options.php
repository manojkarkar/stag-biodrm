...
function thegem_theme_add_page() {
	$page = add_theme_page(esc_html__('Bioderm theme options','thegem'), esc_html__('Theme options','thegem'), 'edit_theme_options', 'options-framework', 'thegem_theme_options_page');
}
